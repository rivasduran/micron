    ...
    ?>
        <script>
            ...
            function actualizar_invu2(cantidadPaginas, posicion){
                ...
                var nueva_posicion = cantidadPaginas;

                if(posicion <= cantidadPaginas){

                    //variable a consultar
                    if(posicion != 1){
                        nueva_posicion = cantidadPaginas - posicion;
                    }else{
                        nueva_posicion = cantidadPaginas;
                    }
                    
                    console.log("=================> La posicion de la pagina es: ("+posicion+") y la pagina enviada es: ("+nueva_posicion+")");
